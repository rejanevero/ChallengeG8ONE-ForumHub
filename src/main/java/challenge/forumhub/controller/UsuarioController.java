...
import challenge.forumhub.service.UsuarioService;
...
public class UsuarioController {
    ...
    @GetMapping
    @Operation(summary = "Listar Usuários Cadastrados", description = "Lista todos os usuários cadastrados com a opção de filtrar por usuários ativos. A ordenação padrão é pelo ID do usuário em páginas de 10 itens.")
